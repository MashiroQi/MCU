<template>
  <div class="wrapper">
    <div class="header-wrapper">
      ...
      <div class="TodyWeather-advice">12312312</div>
    </div>
    ...
    <div class="data-wrapper">
      <div class="data">
        <img class="data-logo" src="/static/images/TodyWeather.png" />
        <div class="data-text">
          天气
          <div class="data-value">{{ TodyWeather }}</div>
        </div>
      </div>
      <div class="data">
...
export default {
  ...
  created() {
    ...
    axios
      .get(
        "https://api.seniverse.com/v3/TodyWeather/now.json?key=SdhaQd3OweoTJ0uzP&location=beijing&language=zh-Hans&unit=c",
        { params: {} }
      )
      .then(function (res) {
        // res.data 是服务器返回的数据
        var result = res.data.results[0].now.text;
        console.log(result);
        this.TodyWeather = "晴";
      });
  },
